      ...
      <div class="main_container" id="forms_page">
        <div class="row-fluid">
          <ul class="breadcrumb">
            ...
            <li><a href="firstClass/list">一级类别</a> <span class="divider">/</span></li>
            <li class="active">修改一级类别</li>
          </ul>
          <h2 class="heading">
             	 修改一级类别
                <span class="btn-group pull-right">
                  <button class="btn" onclick="window.location.href='firstClass/list'"><i class="icon-signout"></i> 返回</button>
                </span>
          </h2>
        </div>
        <div class="row-fluid">
          <div class="widget widget-padding span12">
            <div class="widget-header">
              <i class="icon-list-alt"></i><h5>一级类别信息</h5>
            </div>
            <div class="widget-body">
              <div class="widget-forms clearfix">
              
                <form action="firstClass/update" method="post" id="myform" class="form-horizontal" onsubmit="return isfull();">
                  <input type="hidden" name="f_id" value="${f.f_id}">
                  <div class="control-group">
                    <label class="control-label">名称</label>
                    <div class="controls">
                      <input type="text" placeholder="请填写分类名称" name="name" id="name"  maxlength="10" onchange="checkName();" value="${f.name}">
