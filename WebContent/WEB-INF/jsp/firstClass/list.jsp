  ...
  <div id="wrap">
        ...
        <div class="accordion" id="accordion2">
          ...
          <div class="accordion-group">
            ...
            <div id="collapse2" class="accordion-body in collapse">
              <div class="accordion-inner">
                <a class="accordion-toggle active" href="firstClass/list"><i class="icon-tag"></i> 一级类别</a>
          ...
          <div class="accordion-group">
            ...
            <div id="collapse3" class="accordion-body collapse">
              <div class="accordion-inner">
                ...
                <a class="accordion-toggle" href="goods/hiddenList"><i class="icon-lock"></i> 仓库管理</a>i> 仓库管理</a>
              </div>
            </div>
          </div>
          </c:if>
      ...
      <div class="main_container" id="tables_page">
        <div class="row-fluid">
          <ul class="breadcrumb">
            ...
            <li><a href="firstClass/list">一级类别管理</a> <span class="divider">/</span></li>
            <li class="active">查看一级类别</li>
          </ul>
          <h2 class="heading">
             	   查看一级类别
                <div class="btn-group pull-right">
                  <button class="btn" onclick="window.location.href='firstClass/addShow'"><i class="icon-signin"></i> 添加</button>
                </div>
          </h2>
        </div>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-right">
                          <li><a href="firstClass/updateShow?f_id=${f.f_id}"><i class="icon-edit"></i> 修改</a></li>
                          <li><a onclick="ok('firstClass/delete?f_id=${f.f_id}','${f.name}',this);"><i class="icon-trash"></i> 删除</a></li>
                        </ul>
                      </div>
                    </td>
                  </tr>
    ...
    <script type="text/javascript">
    	function ok(url,name) {
    		 alertify.confirm( '確認刪除分类\"'+name+'\"及下属分类？', function (e) {
    	            if (e) {
