          ...
          <div class="widget widget-padding span12">
            ...
            <div class="widget-body">
              <div class="widget-forms clearfix">
                ...
                <form action="secondClass/update" method="post" id="myform" class="form-horizontal" onsubmit="return isfull();">
                  <input type="hidden" name="s_id" value="${s.s_id}">
                  <div class="control-group">
                    <label class="control-label">名称</label>
                    <div class="controls">
                      <input type="text" placeholder="请填写分类名称" name="name" id="name"  maxlength="10" onchange="checkName();" value="${s.name}">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                     <c:forEach items="${list}" var="f" varStatus="vs">
                      <input type="radio" name="f_id" value="${f.f_id}" <c:if test="${f.f_id==s.f_id}">checked='checked'</c:if> />${f.name}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
