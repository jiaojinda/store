        ...
        <div class="row-fluid">
          ...
          <h2 class="heading">
                ...
                <div class="btn-group pull-right">
                  <button class="btn" onclick="window.location.href='customer/hiddenList'"><i class="icon-refresh"></i> 恢复</button>
                </div>
          </h2>
        </div>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-right">
                          <li><a href="customer/hide?c_id=${c.c_id}"><i class="icon-trash"></i>封号</a></li>
                        </ul>
                      </div>
                    </td>
                  </tr>
