...
<title>Insert title here</title>
 <meta name="viewport" content="width=device-width, initial-scale=1.0">
        ...
        <div class="row-fluid">
          <div class="widget widget-padding span12">
            <div class="widget-header">
              <i class="icon-list-alt"></i><h5>密码信息</h5>
            </div>
            <div class="widget-body">
              <div class="widget-forms clearfix">
              
                <form action="employee/updatePwd" method="post" enctype="multipart/form-data" id="myform" class="form-horizontal" onsubmit="return isfull();">
                  <input type="hidden" name="e_id" value="${e.e_id}">
                  <input type="hidden" id="oldPwd" value="${e.password}">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input class="span7 tip" type="password" placeholder="十位以内数字、字母组合"  id="psw0" maxlength="10">
                    </div>
                  </div>
  ...
  //前台验证
    function isfull() {
    	//是否填写密码
        var txt0=document.getElementById("psw0");//通过ID属性控制对象
        var message=txt0.value;
        if(message==""){
            alertify.alert( '请输入旧密码', function () {
                   // after clicking OK
                   txt0.focus();//获得焦点，友好性
               });
            return false;
        ...
        if (txt0.value != oldPwd.value) {
            alertify.alert( '旧密码输入有误', function () {
                // after clicking OK
                txt0.focus();//获得焦点，友好性
            });
            return false;
