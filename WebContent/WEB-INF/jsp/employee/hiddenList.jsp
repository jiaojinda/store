  ...
  <div id="wrap">
                ...
                <tbody align="center">
                  ...
                  <tr>
                    <td width="100">
						<div class="gallery-item" id="gallery_page">
      				  	<a href="assets/img/gallery/1.jpg" rel="facybox"><img src="assets/img/gallery/1.jpg" alt="" width="100" height="100"></a>
      				    </div>
					</td>
                    <td><b>1</b></td>
                    <td><b>1</b></td>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-right">
                          <li><a href="index/backShow"><i class="icon-edit"></i> 修改</a></li>
                          <li><a href="index/backShow"><i class="icon-trash"></i> 删除</a></li>
                        </ul>
                      </div>
                    </td>
                  </tr>
                 ...
                 <c:forEach items="${list}" var="e">
                  <tr>
                    <td width="100">
						<div class="gallery-item" id="gallery_page">
      				  	<a href="upload/${e.photo}" rel="facybox"><img src="upload/${e.photo}" alt="" width="100" height="100"></a>
      				    </div>
					</td>
                    <td><b>${e.name}</b></td>
                    <td><b><font color="red">${e.account}</font></b></td>
                    <td><b>${e.idcard}</b></td>
                    
                    <td>
                     <b>
                      <c:if test="${e.ren==1}">√</c:if>
                      <c:if test="${e.ren==0}">×</c:if>
                     </b>
                    </td>
                    <td>
                     <b>
                      <c:if test="${e.lei==1}">√</c:if>
                      <c:if test="${e.lei==0}">×</c:if>
                     </b>
                    </td>
                    <td>
                     <b>
                      <c:if test="${e.huo==1}">√</c:if>
                      <c:if test="${e.huo==0}">×</c:if>
                     </b>
                    </td>
                    <td>
                     <b>
                      <c:if test="${e.xin==1}">√</c:if>
                      <c:if test="${e.xin==0}">×</c:if>
                     </b>
                    </td>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-right">
                          <li><a href="employee/recover?e_id=${e.e_id}"><i class="icon-reply"></i> 恢复</a></li>
                          <li><a onclick="return ok('employee/delete?e_id=${e.e_id}','${e.name}',this);"><i class="icon-trash"></i> 永久删除</a></li>
                        </ul>
                      </div>
                    </td>
                  </tr>
    ...
    <script type="text/javascript">
    	function ok(url,name) {
    		 alertify.confirm( '確認永久刪除'+name+'的信息？', function (e) {
    	            if (e) {
