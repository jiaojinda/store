        ...
        <div class="row-fluid">
          ...
          <h2 class="heading">
                ...
                <div class="btn-group pull-right">
                  <button class="btn" onclick="window.location.href='employee/hiddenList'"><i class="icon-refresh"></i> 恢复</button>
                  <button class="btn" onclick="window.location.href='employee/addShow'"><i class="icon-signin"></i> 添加</button>
                </div>
          </h2>
        </div>
              ...
              <table id="users" class="table table-striped table-bordered dataTable">
                ...
                <tbody align="center">
                 ...
                 <c:forEach items="${list}" var="e">
                    <c:if test="${employee.e_id != e.e_id }">
                  <tr>
                    <td width="100">
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-right">
                          <li><a href="employee/updateShow?e_id=${e.e_id}"><i class="icon-edit"></i> 修改</a></li>
                          <li><a href="employee/hide?e_id=${e.e_id}"><i class="icon-trash"></i> 删除</a></li>
                        </ul>
                      </div>
                    </td>
                  </tr>
