...
<div class="banner-top">
	<div class="container">
		<h2 class="animated wow fadeInLeft" data-wow-delay=".5s">商品评价</h2>
		<h3 class="animated wow fadeInRight" data-wow-delay=".5s"><a href="index.html">首页</a><label>/</label>商品评价</h3>
		<div class="clearfix"> </div>
	</div>
</div>
<!-- contact -->
...
<div class="container">
  ...
  <div class="bs-example wow fadeInRight animated" data-wow-delay=".5s" data-example-id="simple-horizontal-form">
    <form class="form-horizontal" action="indent/pingjia" method="post">
    
      <div class="form-group">
        <h1 align="center"> <b>${g.title}</b></h1>
      </div>
    
      <div class="form-group"> 
        <p align="center"><img src="${basePath}upload/${g.photo1}" class="img-responsive" alt=""></p>
      </div>
    <input type="hidden" name="g_id" value="${i.g_id}">
    <input type="hidden" name="i_id" value="${i.i_id}">
      <div class="form-group">
        <label for="inputEmail3" class="col-sm-2 control-label">评价</label>
        <div class="col-sm-10">
          <input type="radio" name="evaluation" value="1"><font color="red">好评</font>&nbsp;&nbsp;&nbsp;
          <input type="radio" name="evaluation" value="2" checked="checked"><font color="green">中评</font>&nbsp;&nbsp;&nbsp;
          <input type="radio" name="evaluation" value="3"><font color="blue">差评</font>&nbsp;&nbsp;&nbsp;
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" placeholder="评论" name="comment">
        </div>
      </div>
