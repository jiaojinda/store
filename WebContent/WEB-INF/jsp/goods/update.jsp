  ...
  <div id="wrap">
          ...
          <div class="accordion-group">
            ...
            <div id="collapse2" class="accordion-body collapse">
              <div class="accordion-inner">
                ...
                <a class="accordion-toggle" href="secondClass/list"><i class="icon-tags"></i> 二级类别</a>/a>
              </div>
            </div>
          </div>
          </c:if>
          ...
          <div class="widget widget-padding span12">
            ...
            <div class="widget-body">
              <div class="widget-forms clearfix">
                ...
                <form action="goods/update" method="post" enctype="multipart/form-data" id="myform" class="form-horizontal" onsubmit="return isfull();">
                  <input type="hidden" name="g_id" value="${g.g_id}">
                  <div class="control-group">
                    <label class="control-label">标题</label>
                    <div class="controls">
                      <input class="span7" type="text" placeholder="请填写标题" name="title" id="title" value="${g.title}"  maxlength="20" onkeyup="value=value.replace(/[^\u4E00-\u9FA5]/g,'')">
                    </div>
                  </div>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input class="span7" type="text" placeholder="请填写品牌" name="brand" id="brand" value="${g.brand}" maxlength="20">
                    </div>
                  </div>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input class="span7" type="text" placeholder="请填写型号" name="model" id="model" value="${g.model}"  maxlength="20">
                    </div>
                  </div>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input class="span7" type="text" placeholder="请填写库存" name="stock" id="stock" value="${g.stock}"  maxlength="5" onkeyup="value=this.value.replace(/\D+/g,'')">
                    </div>
                  </div>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input class="span7" type="text" placeholder="请填写型号" name="price" id="price" value="${g.price}"  maxlength="5" onkeyup="value=this.value.replace(/\D+/g,'')">
                    </div>
                  </div>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <select class="span3" onchange="secondClasses();" id="firstClass">
                      	...
                      	<option value="${f.f_id}" <c:if test="${f.f_id==f_id}">selected="selected"</c:if>>${f.name}</option>
                      	</c:forEach>
                      </select>
                      	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;二级分类&nbsp;&nbsp;&nbsp;
                      <select class="span3" id="secondClass" name="s_id">
                      	<c:forEach items="${secondClassList}" var="s">
                      	<option value="${s.s_id}" <c:if test="${s.s_id==g.s_id}">selected="selected"</c:if>>${s.name}</option>
                      	</c:forEach>
                      </select>
                    </div>
                  </div>
                   ...
                   <label class="control-label">主图</label>
                    <div class="controls">
                     ...
                     <div id="preview">
								<img id="imghead" width="350" height="200" src="upload/${g.photo1}"/>
					 </div>
                    </div>
                  </div>
                   <div class="control-group">
                   <label class="control-label">图二</label>
                    <div class="controls">
                     ...
                     <div id="preview2">
								<img id="imghead2" width="350" height="200"  src="upload/${g.photo2}"/>
					 </div>
                   </div>
                  </div>
                   <div class="control-group">
                   <label class="control-label">图三</label>
                    <div class="controls">
                     ...
                     <div id="preview3">
								<img id="imghead3" width="350" height="200" <c:if test="${g.photo3!=''}"> src="upload/${g.photo3}"</c:if>/>
					 </div>
                    </div>
                  </div>
                   ...
                   <label class="control-label">促销</label>
                    <div class="controls">
                    <input type="hidden" value="${g.promotion}" id="promotion">
                  ...
                  <div class="control-group">
                   <label class="control-label">商品介绍</label>
                    <div class="controls">
                        <textarea name="introduction" id="introduction">${g.introduction}</textarea>
                    </div>
                  </div>
	...
	$(function(){
		if($("#promotion").val()!=0){
			 $("#cuxiaoselect").val("1");
			 iscuxiao();
			 $("#cuxiaoinput").attr('value',$("#promotion").val());
		}
	}); 
    </script>
  </body>
