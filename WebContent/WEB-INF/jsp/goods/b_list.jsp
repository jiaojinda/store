                  ...
                  <tr>
                    ...
                    <c:choose>
                    	...
                    	<b>无</b>
                   	 	...
                   	 	<c:otherwise>
                    	<font color="blue"> ${g.promotion}</font>
      				  	</c:otherwise>
      				</c:choose>
                    </b>
                    </td>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-right">
                          <li><a href="goods/updateShow?g_id=${g.g_id}"><i class="icon-edit"></i> 修改</a></li>
                          <li><a href="goods/hide?g_id=${g.g_id}"><i class="icon-trash"></i>下架</a></li>
                        </ul>
                      </div>
                    </td>
                  </tr>
