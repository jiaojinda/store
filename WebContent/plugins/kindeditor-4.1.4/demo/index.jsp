...
<html>
	...
	<body>
		...
		<script charset="utf-8" src="<%=path%>plugins/kindeditor-4.1.4/kindeditor-min.js"></script>
		<script charset="utf-8" src="<%=path%>plugins/kindeditor-4.1.4/lang/zh_CN.js"></script>
		<script charset="utf-8" src="<%=path%>plugins/kindeditor-4.1.4/simple.js"></script>
